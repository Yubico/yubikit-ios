...
@interface YKFKeySessionConfigurationTests: YKFTestCase

@property (nonatomic) YKFKeySessionConfiguration *sessionConfiguration;
@property (nonatomic) FakeEAAccessory *accessory;

@end

@implementation YKFKeySessionConfigurationTests

- (void)setUp {
    [super setUp];
    self.sessionConfiguration = [[YKFKeySessionConfiguration alloc] init];
