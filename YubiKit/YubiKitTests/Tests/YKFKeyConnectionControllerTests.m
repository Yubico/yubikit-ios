...
@interface YKFKeyConnectionControllerTests: YKFTestCase
...
@implementation YKFKeyConnectionControllerTests
...
- (void)test_WhenConnectionControllerIsCreated_SessionStreamsAreOpened {
    ...
    YKFKeyConnectionController *connectionController = [[YKFKeyConnectionController alloc] initWithSession:self.eaSession operationQueue:self.operationQueue];
...
- (void)test_WhenConnectionControllerWritesCommands_CommandsAreWrittenToTheOutputStream {
    ...
    XCTAssert([writtenData isEqualToData:commandData], @"Command data doesn't match written data.");
}
...
- (void)test_WhenConnectionControllerWritesCommands_ResponseIsReadFromTheInputStream {
    ...
    XCTAssert([response isEqualToData:inputData], @"Response data doesn't match the input data.");
}
