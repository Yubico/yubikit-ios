...
@interface YKFNFCReaderSession()<NFCNDEFReaderSessionDelegate>
...
@implementation YKFNFCReaderSession
...
- (void)readerSession:(NFCNDEFReaderSession *)session didDetectNDEFs:(NSArray<NFCNDEFMessage *> *)messages {
    ...
    if (otpToken) {
        ...
        YKFNFCReadError *error = [YKFNFCReadError noTokenAfterScanError];
        self.nfcOTPResponseBlock(nil, error);
        self.nfcOTPResponseBlock = nil;
    }
}
