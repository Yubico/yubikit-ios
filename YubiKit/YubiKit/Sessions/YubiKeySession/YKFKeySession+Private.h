...
typedef void (^YKFKeySessionStateChangeBlock)(YKFKeySessionState, YKFKeySessionState);

@interface YKFKeySession()
...
- (nullable instancetype)initWithAccessoryManager:(nonnull id<YKFEAAccessoryManagerProtocol>)accessoryManager
                                    configuration:(nonnull YKFKeySessionConfiguration *)configuration;
