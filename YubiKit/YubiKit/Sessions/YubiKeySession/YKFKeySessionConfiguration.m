...
// Protocols
static NSString* const YKFKeySessionConfigurationYLPProtocolName = @"com.yubico.ylp";

// Manufactures
static NSString* const YKFKeySessionConfigurationYubicoManufacturesName = @"Yubico";

@interface YKFKeySessionConfiguration()
...
@implementation YKFKeySessionConfiguration

- (instancetype)init {
    self = [super init];
    if (self) {
        self.allowedProtocols = @[YKFKeySessionConfigurationYLPProtocolName];
        self.allowedManufactures = @[YKFKeySessionConfigurationYubicoManufacturesName];
    }
    return self;
}

#pragma mark - YKFKeySessionConfigurationDelegate
