...
/*!
 @abstract
    Key to fetch clientPin value from YKFFIDO2GetInfoResponse.options
 ...
 */
extern NSString* const YKFFIDO2GetInfoResponseOptionClientPin;

/*!
 @abstract
    Key to fetch plat value from YKFFIDO2GetInfoResponse.options
 ...
 */
extern NSString* const YKFFIDO2GetInfoResponseOptionPlatformDevice;

/*!
 @abstract
    Key to fetch rk value from YKFFIDO2GetInfoResponse.options
 ...
 */
extern NSString* const YKFFIDO2GetInfoResponseOptionResidentKey;

/*!
 @abstract
    Key to fetch up value from YKFFIDO2GetInfoResponse.options
 @discussion
    Indicates that the device is capable of testing user presence.
 */
extern NSString* const YKFFIDO2GetInfoResponseOptionUserPresence;

/*!
 @abstract
    Key to fetch uv value from YKFFIDO2GetInfoResponse.options
 @discussion
    Indicates that the device is capable of verifying the user within itself.
 */
extern NSString* const YKFFIDO2GetInfoResponseOptionUserVerification;

/**
 * ---------------------------------------------------------------------------------------------------------------------
 * @name YKFFIDO2GetInfoResponse
 * ---------------------------------------------------------------------------------------------------------------------
 */
 ...
 */
@interface YKFFIDO2GetInfoResponse: NSObject
