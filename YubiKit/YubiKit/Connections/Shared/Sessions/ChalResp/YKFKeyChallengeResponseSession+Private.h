...
@interface YKFKeyChallengeResponseSession()<YKFSessionProtocol>

typedef void (^YKFKeyChallengeResponseSessionCompletion)(YKFKeyChallengeResponseSession *_Nullable, NSError* _Nullable);
