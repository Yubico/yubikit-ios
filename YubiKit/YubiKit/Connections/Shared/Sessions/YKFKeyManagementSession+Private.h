...
@interface YKFKeyManagementSession()<YKFSessionProtocol>

typedef void (^YKFKeyManagementSessionCompletion)(YKFKeyManagementSession *_Nullable, NSError* _Nullable);
